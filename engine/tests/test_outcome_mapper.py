...
class TestOutputFormat:
    ...
    def test_all_known_categories_covered(self, mapper):
        ...
        # OM is now an instance, use instance attributes
        rules = OM.CONVERSION_RULES if hasattr(OM, 'CONVERSION_RULES') else OM.DEFAULT_CONFIG["category_mappings"]
        for rule in rules:
