...
class TestRejectionPatternMatching:
    ...
    def test_all_patterns_have_keywords(self, analyzer):
        ...
        # RA is now an instance, use instance attributes
        patterns = RA.REJECTION_PATTERNS if hasattr(RA, 'REJECTION_PATTERNS') else RA.DEFAULT_CONFIG["rejection_patterns"]
