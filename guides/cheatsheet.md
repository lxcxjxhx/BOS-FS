...
|---|-------|------|------|------|------|----------|
| 1 | Goal Refiner | skills/goal-refiner/SKILL.md | 提炼项目意图 | 项目描述 | {persona,problem,solution,outcome} | 描述项目时 |
| 2 | Reviewer Simulator | skills/reviewer-simulator/SKILL.md | 模拟五类评审 | 项目信息 | 通过概率/拒绝理由/建议 | 预审时 |
| 3 | README Refactor | skills/readme-refactor/SKILL.md | 重构项目文档 | 原始 README | What/Why/How/Result/Next | 优化文档时 |
| 4 | Outcome Mapper | skills/outcome-mapper/SKILL.md | Feature→Value | 功能描述 | Capability→Outcome | 价值转换时 |
| 5 | Submission Builder | skills/submission-builder/SKILL.md | 构建交付包 | 项目信息 | submission_bundle/ | 准备提交时 |
| 6 | Reject Analyzer | skills/reject-analyzer/SKILL.md | 分析被拒原因 | 拒绝说明 | 真实问题/修复建议 | 项目被拒时 |
| 7 | Pipeline | skills/bos-fs-pipeline/SKILL.md | 完整流水线编排 | 项目描述 | 端到端优化结果 | 完整优化时 |
...
| Review Simulation | 24% | 五类评审平均通过率 |
