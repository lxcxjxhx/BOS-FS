...
**文件**: `skills/goal-refiner/SKILL.md`
...
**文件**: `skills/reviewer-simulator/SKILL.md`

**用途**: 模拟五类评审（technical/investment/product/opensource/adversarial），输出通过概率和改进建议
...
**文件**: `skills/readme-refactor/SKILL.md`
...
**文件**: `skills/outcome-mapper/SKILL.md`
...
**文件**: `skills/submission-builder/SKILL.md`
...
**文件**: `skills/reject-analyzer/SKILL.md`
...
| 完整流程 | 使用 `skills/bos-fs-pipeline/SKILL.md` 编排器 |
