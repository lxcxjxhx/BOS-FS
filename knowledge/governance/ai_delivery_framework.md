...
应用: Goal Refiner (`01_goal_refiner.md`)
```
...
应用: Outcome Mapper (`04_outcome_mapper.md`)
```
...
应用: Readme Refactor (`03_readme_refactor.md`)
```
...
应用: Reviewer Simulator (`02_reviewer_simulator.md`)
```
...
应用: Reject Analyzer (`06_reject_analyzer.md`)
```
...
| 推断必须标注 | 推断值标注"（推断）" | `01_goal_refiner.md` |
