...
> Python 引擎层运行状态机。与 `skills/bos-fs-pipeline/SKILL.md`（AI Skill 编排）正交，本文件描述 Python runtime orchestrator 的内部状态模型。
...
| Stage ID | 知识文件 |
|----------|----------|
| `understand` | `knowledge/intent/discovery_framework.md`, `knowledge/intent/product_value_framework.md`, `knowledge/base_context.md` |
| `map` | `knowledge/intent/product_value_framework.md`, `knowledge/governance/metrics_framework.md`, `knowledge/base_context.md` |
| `review` | `knowledge/governance/rubrics.md`, `knowledge/governance/review_rules/*.md`, `knowledge/governance/ai_delivery_framework.md` |
| `refactor` | `knowledge/execution/templates/readme_template.md`, `knowledge/intent/product_value_framework.md` |
| `build` | `knowledge/execution/templates/*.md`, `knowledge/governance/trust_framework.md`, `knowledge/governance/ai_delivery_framework.md` |
| `analyze` | `knowledge/governance/rubrics.md`, `knowledge/governance/ai_delivery_framework.md` |

### 扩展知识源（按需加载）

| 知识域 | 知识文件 | 适用场景 |
|--------|----------|---------|
| 团队组织 | `knowledge/adoption/team_topology.md` | 多团队协作场景 |
| 效能度量 | `knowledge/adoption/flow_metrics.md` | Pipeline 效能分析 |
| 架构设计 | `knowledge/runtime/architecture_patterns.md` | Custom Stage 开发 |
